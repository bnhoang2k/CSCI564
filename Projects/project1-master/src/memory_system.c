                                                ...
                                                uint32_t tag)
{
    ...
    // Lecture 4: Slides 26 - 28
    // In the context of a cache:
    // Indexes are used to find the set.
    // Tags are used to find the cache line within the set.
    // Offsets are used to find the byte within the cache line.

    // To locate a cache line, we need to find the set and then iterate through the cache lines in that set.
